...
console.log('🚀 Ocağın İçindeki Tüm Turuncu Ateş ve Korlar Tamamen Kesiliyor (0 Ateş)...');

// Turuncu/Kırmızı ateş bölgesini (%55) tamamen kesip sadece üst taş kemer ve dumanı alma (Üst %45)
...
try {
  ...
  console.log('✅ Sıfır Ateşli, Sadece Taş Kemer & Beyaz Duman İçeren 4K day-video.mp4 Üretildi!');
} catch (err) {
